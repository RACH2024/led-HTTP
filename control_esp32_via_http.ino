...
const int LED_OUTPUT  = 22; // declare GPIO 27 as an output
const int Push_Button = 33; // declare GPIO 26 as an input
...
<body>
  <center><h2>ESP32-ESP8266 Web Server</center>
  %BUTTONPLACEHOLDER%
...
String processor(const String& var){
  ...
  if(var == "BUTTONPLACEHOLDER"){
    ...
    buttons+= "<h4>Output - GPIO 27-LED - State <span id=\"outputState\"></span></h4><label class=\"switch\"><input type=\"checkbox\" onchange=\"toggleCheckbox(this)\" id=\"output\" " + outputStateValue + "><span class=\"slider\"></span></label>";
    return buttons;
  }
  return String();
}
